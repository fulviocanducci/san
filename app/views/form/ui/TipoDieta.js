Ext.define('SAN.form.ui.TipoDieta', {
    ...
    getBotaoNovo: function() {
        if (!this.botaoNovo) {
            this.botaoNovo = Ext.widget("button", {
                ...
                handler: function() {
                    Ext.create('SAN.window.TipoDieta').show();
                },
                scope: this
            });
        }
        ...
        if (!this.botaoEditar) {
            this.botaoEditar = Ext.widget("button", {
                ...
                handler: function() {
                    ...
                    Ext.create('SAN.window.TipoDieta', {
                        tipodieta_id: record[0].data.id
                    }).show();
                },
                scope: this
            });
    ...
    getGridSistema: function() {
        if (!this.gridSistema) {
            ...
            {
                xtype: 'gridpanel',
                title: 'Tipo de Dietas Cadastradas',
                store:this.storeTipoDieta,
                columns: [
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'id',
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn: function(resp) {
                            if (resp == 'yes') {
                                Ext.Ajax.request({
                                    url: TCE.SAN.getUrlController('TipoDieta','excluirTipoDieta'),
                                    params: {
                                        id:record[0].data.id
                                    },
                                    scope:this,
