Ext.define('SAN.form.ui.Patologia', {
    ...
    getBotaoNovo: function() {
        if (!this.botaoNovo) {
            this.botaoNovo = Ext.widget("button", {
                ...
                handler: function() {
                    Ext.create('SAN.window.Patologia').show();
                },
                scope: this
            });
        }
        ...
        if (!this.botaoEditar) {
            this.botaoEditar = Ext.widget("button", {
                ...
                handler: function() {
                    ...
                    Ext.create('SAN.window.Patologia', {
                        patologia_id: record[0].data.id
                    }).show();
                },
                scope: this
            });
    ...
    getGridSistema: function() {
        if (!this.gridSistema) {
            ...
            {
                xtype: 'gridpanel',
                title: 'Patologias Cadastradas',
                store:this.storePatologia,
                columns: [
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'id',
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn: function(resp) {
                            if (resp == 'yes') {
                                Ext.Ajax.request({
                                    url: TCE.SAN.getUrlController('Patologia','excluirPatologia'),
                                    params: {
                                        id:record[0].data.id
                                    },
                                    scope:this,
