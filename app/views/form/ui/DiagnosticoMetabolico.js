Ext.define('SAN.form.ui.DiagnosticoMetabolico', {
    extend: 'Champion.form.Base',
    title: 'Diagnósticos Metabólicos',
    bodyPadding: 5,
    layout: 'fit',
    ...
    getBotaoNovo: function() {
        if (!this.botaoNovo) {
            this.botaoNovo = Ext.widget("button", {
                ...
                handler: function() {
                    Ext.create('SAN.window.DiagnosticoMetabolico').show();
                },
                scope: this
            });
        }
        ...
        if (!this.botaoEditar) {
            this.botaoEditar = Ext.widget("button", {
                ...
                handler: function() {
                    ...
                    Ext.create('SAN.window.DiagnosticoMetabolico', {
                        diagnosticometabolico_id: record[0].data.id
                    }).show();
                },
                scope: this
            });
    ...
    getGridSistema: function() {
        if (!this.gridSistema) {
            ...
            {
                xtype: 'gridpanel',
                title: 'Diagnósticos Metabólicos Cadastradas',
                ...
                listeners: {
                    ...
                    itemdblclick: function(el, record) {
                        Ext.create('SAN.window.DiagnosticoMetabolico', {
                            diagnosticometabolico_id: record.data.id
                        }).show();
                    },
                    scope: this
                },
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn: function(resp) {
                            if (resp == 'yes') {
                                Ext.Ajax.request({
                                    url: TCE.SAN.getUrlController('DiagnosticoMetabolico','excluirDiagnosticoMetabolico'),
                                    params: {
                                        id:record[0].data.id
                                    },
                                    scope:this,
