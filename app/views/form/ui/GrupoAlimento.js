Ext.define('SAN.form.ui.GrupoAlimento', {
    ...
    getBotaoNovo: function() {
        if (!this.botaoNovo) {
            this.botaoNovo = Ext.widget("button", {
                ...
                handler: function() {
                    Ext.create('SAN.window.GrupoAlimento').show();
                },
                scope: this
            });
        }
        ...
        if (!this.botaoEditar) {
            this.botaoEditar = Ext.widget("button", {
                ...
                handler: function() {
                    ...
                    Ext.create('SAN.window.GrupoAlimento', {
                        grupoalimento_id: record[0].data.id
                    }).show();
                },
                scope: this
            });
    ...
    getGridSistema: function() {
        if (!this.gridSistema) {
            ...
            {
                xtype: 'gridpanel',
                title: 'Grupo de Alimentos Cadastrados',
                store:this.storeGrupoAlimento,
                columns: [
                {
                    xtype: 'gridcolumn',
                    dataIndex: 'id',
                ...
                listeners: {
                    ...
                    itemdblclick: function(el, record) {
                        Ext.create('SAN.window.GrupoAlimento', {
                            grupoalimento_id: record.data.id
                        }).show();
                    },
                    scope: this
                },
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn: function(resp) {
                            if (resp == 'yes') {
                                Ext.Ajax.request({
                                    url: TCE.SAN.getUrlController('GrupoAlimento','excluirGrupoAlimento'),
                                    params: {
                                        id:record[0].data.id
                                    },
                                    scope:this,
