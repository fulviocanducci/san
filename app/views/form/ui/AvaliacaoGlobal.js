Ext.define('SAN.form.ui.AvaliacaoGlobal', {
    extend: 'Champion.form.Base',
    title: 'Avalições Globais',
    bodyPadding: 5,
    layout: 'fit',
    ...
    getBotaoNovo: function() {
        if (!this.botaoNovo) {
            this.botaoNovo = Ext.widget("button", {
                ...
                handler: function() {
                    Ext.create('SAN.window.AvaliacaoGlobal').show();
                },
                scope: this
            });
        }
        ...
        if (!this.botaoEditar) {
            this.botaoEditar = Ext.widget("button", {
                ...
                handler: function() {
                    ...
                    Ext.create('SAN.window.AvaliacaoGlobal', {
                        avaliacaoglobal_id: record[0].data.id
                    }).show();
                },
                scope: this
            });
    ...
    getGridSistema: function() {
        if (!this.gridSistema) {
            ...
            {
                xtype: 'gridpanel',
                title: 'Avalições Globais Cadastradas',
                ...
                listeners: {
                    ...
                    itemdblclick: function(el, record) {
                        Ext.create('SAN.window.AvaliacaoGlobal', {
                            avaliacaoglobal_id: record.data.id
                        }).show();
                    },
                    scope: this
                },
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn: function(resp) {
                            if (resp == 'yes') {
                                Ext.Ajax.request({
                                    url: TCE.SAN.getUrlController('AvaliacaoGlobal','excluirAvaliacaoGlobal'),
                                    params: {
                                        id:record[0].data.id
                                    },
                                    scope:this,
