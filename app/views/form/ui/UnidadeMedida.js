Ext.define('SAN.form.ui.UnidadeMedida', {
    ...
    getBotaoNovo: function() {
        if (!this.botaoNovo) {
            this.botaoNovo = Ext.widget("button", {
                ...
                handler: function() {
                    Ext.create('SAN.window.UnidadeMedida').show();
                },
                scope: this
            });
        }
        ...
        if (!this.botaoEditar) {
            this.botaoEditar = Ext.widget("button", {
                ...
                handler: function() {
                    ...
                    Ext.create('SAN.window.UnidadeMedida', {
                        unidademedida_id: record[0].data.id
                    }).show();
                },
                scope: this
            });
            ...
            this.gridSistema = Ext.widget("gridpanel",
            {
                ...
                listeners: {
                    ...
                    itemdblclick: function(el, record) {
                        Ext.create('SAN.window.UnidadeMedida', {
                            unidademedida_id: record.data.id
                        }).show();
                    },
                    scope: this
                },
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn: function(resp) {
                            if (resp == 'yes') {
                                Ext.Ajax.request({
                                    url: TCE.SAN.getUrlController('UnidadeMedida','excluirUnidadeMedida'),
                                    params: {
                                        id:record[0].data.id
                                    },
                                    scope:this,
