Ext.define('SAN.form.ui.Profissao', {
    ...
    getBotaoNovo: function() {
        if (!this.botaoNovo) {
            this.botaoNovo = Ext.widget("button", {
                ...
                handler: function() {
                    Ext.create('SAN.window.Profissao').show();
                },
                scope: this
            });
        }
        ...
        if (!this.botaoEditar) {
            this.botaoEditar = Ext.widget("button", {
                ...
                handler: function() {
                    ...
                    Ext.create('SAN.window.Profissao', {
                        profissao_id: record[0].data.id
                    }).show();
                },
                scope: this
            });
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn: function(resp) {
                            if (resp == 'yes') {
                                Ext.Ajax.request({
                                    url: TCE.SAN.getUrlController('Profissao','excluirProfissao'),
                                    params: {
                                        id:record[0].data.id
                                    },
                                    scope:this,
