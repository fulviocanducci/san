Ext.define('SAN.form.ui.TelefoneTipo', {
    extend: 'Champion.form.Base',
    title: 'Telefones Tipo',
    bodyPadding: 5,
    layout: 'fit',
    ...
    getBotaoNovo: function() {
        if (!this.botaoNovo) {
            this.botaoNovo = Ext.widget("button", {
                ...
                handler: function() {
                    Ext.create('SAN.window.TelefoneTipo').show();
                },
                scope: this
            });
        }
        ...
        if (!this.botaoEditar) {
            this.botaoEditar = Ext.widget("button", {
                ...
                handler: function() {
                    ...
                    Ext.create('SAN.window.TelefoneTipo', {
                        telefonetipo_id: record[0].data.id
                    }).show();
                },
                scope: this
            });
    ...
    getGridSistema: function() {
        if (!this.gridSistema) {
            ...
            {
                xtype: 'gridpanel',
                title: 'Telefones Tipo Cadastradas',
                ...
                listeners: {
                    ...
                    itemdblclick: function(el, record) {
                        Ext.create('SAN.window.TelefoneTipo', {
                            telefonetipo_id: record.data.id
                        }).show();
                    },
                    scope: this
                },
                ...
                handler:function(){
                    ...
                    Ext.Msg.show({
                        ...
                        fn: function(resp) {
                            if (resp == 'yes') {
                                Ext.Ajax.request({
                                    url: TCE.SAN.getUrlController('TelefoneTipo','excluirTelefoneTipo'),
                                    params: {
                                        id:record[0].data.id
                                    },
                                    scope:this,
